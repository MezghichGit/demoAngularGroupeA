...
export class ContactComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   // console.log(this.service.getCours());
    this.service.getListeUsers().subscribe(
      data => {
        //console.log(data);
        this.users = data;
      }
  ...
  somme(calculatrice: NgForm) {
    console.log(calculatrice.value);
    this.resultat = calculatrice.value['a'] + calculatrice.value['b'];
  }
